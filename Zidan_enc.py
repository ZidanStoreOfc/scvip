...
logo = f"\n{p}╔═════════════════════════════════════╗\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 0: {w}𝑷𝑬𝑵𝑮𝑰𝑺𝑰𝑨𝑵 2𝙹𝚞𝚝𝚊         {p}║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 1: {w}𝐏𝐄𝐍𝐆𝐈𝐒𝐈𝐀𝐍 1𝙹𝚞𝚝𝚊         {p}║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 2: {w}𝐏𝐄𝐍𝐆𝐈𝐒𝐈𝐀𝐍 800𝚁𝚒𝚋𝚞      {p} ║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 3: {w}𝐏𝐄𝐍𝐆𝐈𝐒𝐈𝐀𝐍 500𝚁𝚒𝚋𝚞     {p}  ║\n║[{y}•{p}] {r}𝙽𝙾𝙼𝙾𝚁 4: {w}𝐏𝐄𝐍𝐆𝐔𝐑𝐀𝐀𝐒𝐀𝐍 -500𝚁𝚒𝚋𝚞  {p}  ║\n╚═════════════════════════════════════╝{a}"
...
def ketik():
  #os.system("cls||clear")
  print("""\033[97m    RULES
  1.TIDAK BERGARANSI JIKA DI BLOKIR MALEO
  TAPI UDAH JALAN 2+ TAHUN AMAN AMAN AJA
  2.DI LARANG MENJUAL BELIKAN SC INI ( SAYA KUNCI SELAMANYA )
  3.MELANGGAR AUTO BLOKIR""")
  
  
  
  gcg ="https://pastebin.com/raw/mF02G8M0"
  ...
  if gcg_2 == gcg_1:  
      ...
      tesss = 'https://api.telegram.org/bot7023583810:AAE3St6Ado0hJpekIyrC-jN5uvtPE-Vo2Z0/sendMessage?parse_mode=markdown&chat_id=6282628908&text="{}"'.format(gcg_1)
      requests.get(tesss) 
      os.system("cls||clear")
  else:
       os.system("xdg-open  https://wa.me/6285727653691")
       os.system("cls||clear")
       exit(f"{p}[{y}!{p}] {r} PASSWORD SALAH SILAHKAN HUBUNGI 085727653691 {a}")
...
#base_url = 'https://api.telegram.org/bot7023583810:AAE3St6Ado0hJpekIyrC-jN5uvtPE-Vo2Z0/sendMessage?parse_mode=markdown&chat_id=6282628908&text="{}"'.format(nama)
#requests.get(base_url)
auth = input(f"\033[1;33;41m•\033[1;37[TOKEN MASUKKAN DISINI BOS\033[1;33m•\033[0m\033[")
...
\033[1;33;41m • \033[1;37m           ❏ 𝗦𝗖𝗥𝗜𝗣𝗧 𝗧𝗢𝗣 𝗨𝗣 𝙕𝙄𝘿𝘼𝙉 𝙎𝙏𝙊𝙍𝙀 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇 ❏              \033[1;33m• \033[0m\033[")
\033[0;35m{yellow}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
   {red} - 𝗣𝗲𝗺𝗯𝘂𝗮𝘁 {white}𝗭𝗜𝗗𝗔𝗡 𝟬𝟴𝟱𝟳𝟮𝟳𝟲𝟱𝟯𝟲𝟵𝟭  {red}  - 𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠 {white} @𝘇𝗶𝗱𝗮𝗻𝘀𝘁𝗼𝗿𝗲𝗼𝗳𝗳𝗶𝗰𝗶𝗮𝗹
   {red} - 𝗦𝗰𝗿𝗶𝗽𝘁 {white}𝗕𝗨𝗦 𝗦𝗜𝗠𝗨𝗟𝗔𝗧𝗢𝗥 𝗜𝗗     {red}  - 𝙑𝙚𝙧𝙨𝙞𝙤𝙣 {white}   4 
\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
   \33[0;31m𝗠𝗢𝗢𝗡:\33[0;32m{kal:%B            } \33[0;31m𝗗𝗔𝗬:\33[0;32m{kal:%A               }\33[0;31m 𝗧𝗚𝗟:\33[0;32m{kal:%d}
\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
print(f"""
\033[97m     - 𝗝𝗔𝗡𝗚𝗔𝗡 𝗗𝗜𝗝𝗨𝗔𝗟 𝗕𝗘𝗟𝗜𝗞𝗔𝗡 𝗦𝗖 𝗜𝗡𝗜( 𝗦𝗔𝗬𝗔 𝗞𝗨𝗡𝗖𝗜 𝗦𝗘𝗟𝗔𝗠𝗔𝗡𝗬𝗔 )
\033[97m     - 𝗝𝗔𝗡𝗚𝗔𝗡 𝗗𝗜𝗝𝗨𝗔𝗟 𝗕𝗘𝗟𝗜𝗞𝗔𝗡 𝗦𝗖 𝗜𝗡𝗜( 𝗦𝗔𝗬𝗔 𝗞𝗨𝗡𝗖𝗜 𝗦𝗘𝗟𝗔𝗠𝗔𝗡𝗬𝗔 )
\033[97m     - 𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗙𝗢𝗟𝗟𝗢𝗪 𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠 𝗦𝗔𝗬𝗔 𝗗𝗔𝗡 𝗦𝗨𝗣𝗣𝗢𝗥𝗧
\033[97m     - 𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗙𝗢𝗟𝗟𝗢𝗪 𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠 𝗦𝗔𝗬𝗔 𝗗𝗔𝗡 𝗦𝗨𝗣𝗣𝗢𝗥𝗧""")
print(f"""
\033[0;35m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
def warning():
